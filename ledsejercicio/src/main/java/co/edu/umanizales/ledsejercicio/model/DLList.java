...
public class DLList {
    ...
    //recorro la lista
        ...
        if (steps == place){
            ...
            temp.getData().setLaston(new Date(System.currentTimeMillis()));
        }
        steps++;
        temp = temp.getNext();
    }
    ...
    public void turnBulbOff(int place) throws DLListException{
        ...
        while (temp != null){
            ...
            if (steps == place){
                ...
                temp.getData().setLastoff(new Date(System.currentTimeMillis()));
            }
            steps++;
            temp = temp.getNext();
        }
        ...
        if (size % 2 == 0){
            ...
            while (temp != null) {
                ...
                if (steps == (middle + 1)){
                    ...
                    temp2.getData().setLaston(new Date(System.currentTimeMillis()));
                    ...
                    if (temp.getNext() != null){
                        ...
                        while (temp.getNext() != null) {
                            ...
                            temp2.getData().setLastoff(new Date(System.currentTimeMillis()));
